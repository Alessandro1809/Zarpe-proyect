  ...
  return (
    <>
        <div className="flex justify-center gap-3 mb-20 lg:gap-10 md:gap-4 sm:gap-4">
            <Link to='https://www.facebook.com/profile.php?id=61554017310537' target="_blank"> <button className="flex items-center transition duration-500 bg-gray-600 rounded-lg lg:h-12 lg:w-44 hover:scale-110 md:w-40 sm:w-32">
